...
function greetings($nama) {
    return "Halo " .$nama. ", Selamat datang di Garuda Cyber Institute!"; 
...
function palindrome($string) {
    $reversedString = reverseString1($string);
    // Membandingkan string asli
...
// Hapus komentar di bawah ini untuk jalankan code
echo palindrome("civic"); echo "<br>";// true
echo palindrome("nababan") ; echo "<br>";// true
echo palindrome("jambaban") ; echo "<br>";// false
...
// Hapus komentar di bawah ini untuk jalankan code
echo "Nilai 98: "; echo tentukan_nilai(98); echo "<br>";//Sangat Baik
echo "Nilai 76: "; echo tentukan_nilai(76); echo "<br>";//Baik
echo "Nilai 67: "; echo tentukan_nilai(67); echo "<br>";//Cukup
